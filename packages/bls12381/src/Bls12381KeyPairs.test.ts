...
describe('Bls12381KeyPairs', ()=>{
  ...
  it('fromFingerprint', async ()=>{
    const keypairs = await Bls12381KeyPairs.fromFingerprint({
      fingerprint: 'z5TcEur3r2Fe8ketYvNu9Bi1jzVkeSJdMfbyPSzVYjNhfMFUzLYKnApjw9viXv5GD2v7oqGVdohcxducBWQxhNPkG1yGmm69vV4XNThfBNBnqQ4ZXutd3F4zPcxeqsLpgbmuEaDMP5Ak17VPpLcdrSW5PC1FFsAJRjfmSrhwuFxpL7EDj1Mq6cDCPFrLMzF22eGLKdWLX'
    }) as Bls12381KeyPairs;
