...
it('g1', async () => {
  const fingerprint =
    'z5PG8APYnYLS9tczGCUhwyuczQRqRLWkMK2mvSBuoNho9gfJtZSvFSX9DpDPi5CnvdGoFdZwN7CeFbSWuvDY1fK7mRnG1hASENGbUJZQGVt6iWKM21FGFJ8NU21G91S2YbKgU4nFHbcmP8JGjXZS1QtjRw1FBa8eifPj3dddPTbN6WZDH6SEL119ypMCCQgkWhgm22LU8';
...
it('g2', async () => {
  const fingerprint =
    'zUC75EFftXBGgCWu2cHamiGpDVUdp21gPVdsjpmKLLM6bjSuUNZ4YhTyj2EaeVCDf2JtL7DTUjrJBrVcdpKDB4LThkrMoP4dUFug1E75LN8YtscfsdpNi1Da6kV5DiJ94AaEiEU';
